      ...
      <div className="flex flex-wrap mx-auto lg:w-4/5">
        ...
        <div className="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex ">
              <button className="flex px-6 py-2 ml-auto mr-2 text-white bg-green-500 border-0 rounded focus:outline-none hover:bg-indigo-600">
                Buy it now
              </button>
              <button className="flex px-6 py-2 ml-auto border border-indigo-500 rounded focus:outline-none hover:bg-green-600 hover:text-white">
                Add to cart
              </button>
            </div>
