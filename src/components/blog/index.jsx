...
import yellowShea from "../../images/shea butter-white.jpg";
  ...
  const blogPosts = [
    {
      ...
      url: "https://medium.com/@abubakaribilal99/yellow-shea-butter-1e1589b7e0a7",
    },
    // {
    //   imageSrc:
    ...
    <Container>
      <Content>
        <HeadingInfoContainer>
          <HeadingTitle>Blog Posts</HeadingTitle>
          <HeadingDescription>
