 ...
 */
export const checkoutControllerUpdateDeliveryCost = <ThrowOnError extends boolean = false>(options: Options<CheckoutControllerUpdateDeliveryCostData, ThrowOnError>) => (options.client ?? client).patch<CheckoutControllerUpdateDeliveryCostResponses, unknown, ThrowOnError>({
